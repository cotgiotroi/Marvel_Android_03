    ...
    public void getMovies(int tab) {
        ...
        switch (tab) {
            case Constant.POPULAR:
                observable = mRespository.getPopularMovie(Constant.API_KEY);
                break;
            case Constant.UP_COMING:
                observable = mRespository.getUpComingMovie(Constant.API_KEY);
                break;
            case Constant.TOP_RATE:
                observable = mRespository.getTopRateMovie(Constant.API_KEY);
                break;
            case Constant.NOW_PLAYING:
                observable = mRespository.getNowPlayingMovie(Constant.API_KEY);
                break;
            default:
                observable = mRespository.getPopularMovie(Constant.API_KEY);
        }
